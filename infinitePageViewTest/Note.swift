...
class Note: NSManagedObject {
    ...
    class func saveDataOrCeate(_ diary: Diary?, note noteData: Note?, image imageData: Data?, thumbnail thumbnailData: Data? ,comment commentData: String?, date dateData: Date?) throws {
        ...
        if diary == nil {
            ...
            saveOrCreateHashTags(tags: SavingContent.hasTag /* set tags*/ , note: newNote)
        } else {
            ...
            if noteData != nil {
                ...
                saveOrCreateHashTags(tags: nil /* set tags*/ , note: noteData)
                ...
                saveOrCreateHashTags(tags: nil /* set tags*/ , note: newNote)
            }
        }
        do {
            try context.save()
